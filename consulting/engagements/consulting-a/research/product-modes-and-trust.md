...
| E3 | Observed | The current anonymity Feature promises that even admins cannot see an anonymous author while the author can still edit, nominate, withdraw, resolve, and spend available support votes on their own issue; the Feature leaves the author-control mechanism and writing-style re-identification unresolved. | Current [Issue Anonymity](../../../../spec/features/issue/anonymity/README.md), inspected and founder-corrected 2026-08-04 | Promise is unimplemented and has no acceptance criteria |
...
- The current Anonymity Feature promises identity hidden even from admins, but
  requires author control and anonymous self-support budget enforcement while
  leaving the mechanism unresolved. External guidance says such linkable records are normally
