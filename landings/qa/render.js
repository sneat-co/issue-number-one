...
export function formatUpdatedAt(value) {
  ...
  return date.toLocaleDateString('en-IE', { timeZone: 'UTC' });
}
...
export function questionPage(catalog, category, snapshot, selectedSlug) {
  ...
  const { issues, totalRespondents } = snapshot;
  if (snapshot.translation && !snapshot.translationFallback) {
    question = {
      ...question,
      title: snapshot.translation.title || question.title,
      description: snapshot.translation.description || question.description,
    };
  }
